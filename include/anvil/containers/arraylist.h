 ...
 */
ANV_API int anv_arraylist_equals(const ANVArrayList* list1, const ANVArrayList* list2, anv_compare_func compare);
 ...
 * @param should_copy If true, creates deep copies of all elements using alloc->anv_copy_func.
 *                    If false, uses elements directly from iterator.
 *                    When true, alloc->anv_copy_func must not be NULL.
