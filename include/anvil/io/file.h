...
// This implementation provides a simple API for file operations
// with support for custom memory allocation.
 ...
 *
 * This structure maintains file state including the file path, contents,
 * and size. It supports custom memory allocation through the ANVAllocator.
 */
...
/**
 * Create a new file object with custom allocator.
 *
 ...
 * a buffer (allocated using the file's allocator), and null-terminates the buffer.
