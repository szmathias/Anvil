...
//
// Stack frame allocator for fast, temporary memory allocation.
// This implementation provides a fixed-size stack-based allocator that
// allocates memory from a pre-allocated buffer. Deallocations must follow
// LIFO (Last-In-First-Out) order, like a stack.
 ...
 * if there is insufficient space remaining. The returned memory is not
 * initialized.
 *
