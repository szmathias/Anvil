 ...
 */
ANV_API ANVDoublyLinkedList* anv_dll_filter(const ANVDoublyLinkedList* list, anv_predicate_func pred);
 ...
 */
ANV_API ANVDoublyLinkedList* anv_dll_filter_deep(const ANVDoublyLinkedList* list, anv_predicate_func pred);
 ...
 */
ANV_API ANVDoublyLinkedList* anv_dll_transform(const ANVDoublyLinkedList* list, anv_transform_func transform, bool should_free_data);
