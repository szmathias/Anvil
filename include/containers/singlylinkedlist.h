...
// copying or transforming elements the allocator's anv_copy_func and
 ...
 */
ANV_API ANVSinglyLinkedList* anv_sll_filter(const ANVSinglyLinkedList* list, anv_predicate_func pred);

/**
 * Create a new list containing only elements that satisfy the predicate.
 * Performs a deep copy: if the allocator provides anv_copy_func, elements are copied into the new list.
 *
 * @param list Source list
 * @param pred Predicate function
 * @return New list with matching elements (deep copy), or NULL on error
 */
ANV_API ANVSinglyLinkedList* anv_sll_filter_deep(const ANVSinglyLinkedList* list, anv_predicate_func pred);
 ...
 */
ANV_API ANVSinglyLinkedList* anv_sll_transform(const ANVSinglyLinkedList* list, anv_transform_func transform, bool should_free_data);
 ...
 */
ANV_API ANVSinglyLinkedList* anv_sll_copy_deep(const ANVSinglyLinkedList* list, anv_copy_func copy_data, bool should_free_data);
