 ...
 */
ANV_API ANVArrayList* anv_arraylist_filter(const ANVArrayList* list, anv_filter_func filter);
 ...
 */
ANV_API ANVArrayList* anv_arraylist_filter_deep(const ANVArrayList* list, anv_filter_func filter);
 ...
 */
ANV_API ANVArrayList* anv_arraylist_transform(const ANVArrayList* list, anv_transform_func transform, bool should_free_data);
