//
// Consolidated test suite for all iterator functionality.
// Generated by merging 11 individual iterator test files.
//
// Sources: test_iterator_chain.c, test_iterator_chains.c, test_iterator_copy.c,
//          test_iterator_enumerate.c, test_iterator_filter.c, test_iterator_range.c,
//          test_iterator_repeat.c, test_iterator_skip.c, test_iterator_take.c,
//          test_iterator_transform.c, test_iterator_zip.c
//
...
//==============================================================================
// Shared Helper Functions (deduplicated from multiple files)
//==============================================================================
 ...
 * (Standard version from filter/range/transform)
 */
...
//==============================================================================
// Chains-Specific Helper (different implementation from standard version)
//==============================================================================

/**
 * Enhanced helper function with better validation for chains.
 * (From chains tests - has different break/advance logic)
 */
...
//==============================================================================
// Copy-Specific Helper Functions (int** signatures)
//==============================================================================
...
//==============================================================================
// Chain Iterator Tests (from test_iterator_chain.c)
//==============================================================================
...
//==============================================================================
// Iterator Chaining Tests (from test_iterator_chains.c)
//==============================================================================
...
//==============================================================================
// Copy Iterator Tests (from test_iterator_copy.c)
//==============================================================================
...
//==============================================================================
// Enumerate Iterator Tests (from test_iterator_enumerate.c)
//==============================================================================
...
//==============================================================================
// Filter Iterator Tests (from test_iterator_filter.c)
//==============================================================================
...
//==============================================================================
// Range Iterator Tests (from test_iterator_range.c)
//==============================================================================
...
//==============================================================================
// Repeat Iterator Tests (from test_iterator_repeat.c)
//==============================================================================
...
//==============================================================================
// Skip Iterator Tests (from test_iterator_skip.c)
//==============================================================================
...
//==============================================================================
// Take Iterator Tests (from test_iterator_take.c)
//==============================================================================
...
//==============================================================================
// Transform Iterator Tests (from test_iterator_transform.c)
//==============================================================================
...
//==============================================================================
// Zip Iterator Tests (from test_iterator_zip.c)
//==============================================================================
...
//==============================================================================
// Main Test Runner - 225 tests total
//==============================================================================
...
int main(void)
{
    const ANVTestCase tests[] = {
        ...
        // Enumerate Iterator Tests (from test_iterator_enumerate.c)
        {test_enumerate_basic_functionality, "test_enumerate_basic_functionality"},
        {test_enumerate_custom_start_index, "test_enumerate_custom_start_index"},
        {test_enumerate_single_element, "test_enumerate_single_element"},
        {test_enumerate_large_start_index, "test_enumerate_large_start_index"},
        {test_enumerate_empty_source, "test_enumerate_empty_source"},
        {test_enumerate_invalid_parameters, "test_enumerate_invalid_parameters"},
        {test_enumerate_with_filter, "test_enumerate_with_filter"},
        {test_enumerate_with_take, "test_enumerate_with_take"},
        {test_enumerate_with_skip, "test_enumerate_with_skip"},
        {test_enumerate_chained, "test_enumerate_chained"},
        {test_enumerate_arraylist, "test_enumerate_arraylist"},
        {test_enumerate_dll, "test_enumerate_dll"},
        {test_enumerate_queue_with_stack, "test_enumerate_queue_with_stack"},
        {test_enumerate_complex_composition, "test_enumerate_complex_composition"},
        {test_enumerate_iteration_state, "test_enumerate_iteration_state"},
        {test_enumerate_unsupported_operations, "test_enumerate_unsupported_operations"},
        {test_enumerate_element_consistency, "test_enumerate_element_consistency"},
        {test_enumerate_index_overflow_behavior, "test_enumerate_index_overflow_behavior"},
        ...
        // Repeat Iterator Tests (from test_iterator_repeat.c)
        {test_repeat_basic_functionality, "test_repeat_basic_functionality"},
        {test_repeat_single_count, "test_repeat_single_count"},
        {test_repeat_zero_count, "test_repeat_zero_count"},
        {test_repeat_large_count, "test_repeat_large_count"},
        {test_repeat_different_data_types, "test_repeat_different_data_types"},
        {test_repeat_invalid_parameters, "test_repeat_invalid_parameters"},
        {test_repeat_pointer_consistency, "test_repeat_pointer_consistency"},
        {test_repeat_exhausted_iterator, "test_repeat_exhausted_iterator"},
        {test_repeat_reset_functionality, "test_repeat_reset_functionality"},
        {test_repeat_reset_exhausted, "test_repeat_reset_exhausted"},
        {test_repeat_reset_empty, "test_repeat_reset_empty"},
        {test_repeat_with_filter, "test_repeat_with_filter"},
        {test_repeat_with_filter_reject, "test_repeat_with_filter_reject"},
        {test_repeat_with_take, "test_repeat_with_take"},
        {test_repeat_with_take_more_than_available, "test_repeat_with_take_more_than_available"},
        {test_repeat_with_skip, "test_repeat_with_skip"},
        {test_repeat_with_skip_all, "test_repeat_with_skip_all"},
        {test_repeat_with_zip, "test_repeat_with_zip"},
        {test_repeat_with_enumerate, "test_repeat_with_enumerate"},
        {test_repeat_chained_operations, "test_repeat_chained_operations"},
        {test_repeat_with_arraylist, "test_repeat_with_arraylist"},
        {test_repeat_with_range, "test_repeat_with_range"},
        {test_repeat_iteration_state, "test_repeat_iteration_state"},
        {test_repeat_unsupported_operations, "test_repeat_unsupported_operations"},

        // Skip Iterator Tests (from test_iterator_skip.c)
        {test_skip_basic_functionality, "test_skip_basic_functionality"},
        {test_skip_zero_count, "test_skip_zero_count"},
        {test_skip_more_than_available, "test_skip_more_than_available"},
        {test_skip_all_elements, "test_skip_all_elements"},
        {test_skip_single_element, "test_skip_single_element"},
        {test_skip_empty_source, "test_skip_empty_source"},
        {test_skip_invalid_parameters, "test_skip_invalid_parameters"},
        {test_skip_large_count, "test_skip_large_count"},
        {test_skip_with_filter, "test_skip_with_filter"},
        {test_skip_chained, "test_skip_chained"},
        {test_skip_with_take, "test_skip_with_take"},
        {test_skip_iteration_state, "test_skip_iteration_state"},
        {test_skip_lazy_evaluation, "test_skip_lazy_evaluation"},
        {test_skip_unsupported_operations, "test_skip_unsupported_operations"},

        // Take Iterator Tests (from test_iterator_take.c)
        {test_take_basic_functionality, "test_take_basic_functionality"},
        {test_take_zero_count, "test_take_zero_count"},
        {test_take_more_than_available, "test_take_more_than_available"},
        {test_take_single_element, "test_take_single_element"},
        {test_take_empty_source, "test_take_empty_source"},
        {test_take_invalid_parameters, "test_take_invalid_parameters"},
        {test_take_large_count, "test_take_large_count"},
        {test_take_with_filter, "test_take_with_filter"},
        {test_take_chained, "test_take_chained"},
        {test_take_iteration_state, "test_take_iteration_state"},
        {test_take_unsupported_operations, "test_take_unsupported_operations"},
        ...
        // Zip Iterator Tests (from test_iterator_zip.c)
        {test_zip_basic_functionality, "test_zip_basic_functionality"},
        {test_zip_different_lengths_first_shorter, "test_zip_different_lengths_first_shorter"},
        {test_zip_different_lengths_second_shorter, "test_zip_different_lengths_second_shorter"},
        {test_zip_equal_length_single_elements, "test_zip_equal_length_single_elements"},
        {test_zip_both_empty, "test_zip_both_empty"},
        {test_zip_one_empty_first, "test_zip_one_empty_first"},
        {test_zip_one_empty_second, "test_zip_one_empty_second"},
        {test_zip_invalid_parameters, "test_zip_invalid_parameters"},
        {test_zip_with_filter, "test_zip_with_filter"},
        {test_zip_with_take, "test_zip_with_take"},
        {test_zip_with_skip, "test_zip_with_skip"},
        {test_zip_nested, "test_zip_nested"},
        {test_zip_iteration_state, "test_zip_iteration_state"},
        {test_zip_unsupported_operations, "test_zip_unsupported_operations"},
        {test_zip_pair_consistency, "test_zip_pair_consistency"},
        {test_zip_arraylist_iterators, "test_zip_arraylist_iterators"},
        {test_zip_dll_iterators, "test_zip_dll_iterators"},
        {test_zip_arraylist_with_dll, "test_zip_arraylist_with_dll"},
        {test_zip_queue_with_stack, "test_zip_queue_with_stack"},
        {test_zip_range_with_arraylist, "test_zip_range_with_arraylist"},
        {test_zip_filtered_data_structures, "test_zip_filtered_data_structures"},
        {test_zip_complex_composition, "test_zip_complex_composition"},
